...
all <- read.table("~/herbcontemp_poplist.txt", na.strings = c("","NA","?"), sep="\t", header = F)
names(all)[1] <- "sample"
...
meta_ordered <- read.table("~/Documents/UToronto_PhD/Papers/Evolution Preadapt Submission/Evolution2021-Preadapt/commongarden_and_PNAS_metadata_ancestry.txt", header = T)
...
hemi_tree <- read.tree("commongarden_allsites_193_hap2_hemi.min4.phy.treefile")
hemi_tree$tip.label
